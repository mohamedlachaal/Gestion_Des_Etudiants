        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="ajouterClient"   method="post" class="w-50 " style=" position: relative; left:15em;">
                        <!-- 2 column grid layout with text inputs for the first and last names -->
                        <div class="row mb-4">
                            <div class="col">
                                <div class="form-outline">
                                    <label class="form-label" for="form6Example1">Prénom</label>
                                    <input  type="text" id="form6Example1" class="form-control" name="prenom" />
                            ...
                            <div class="col">
                                <div class="form-outline">
                                    ...
                                    <input type="text" id="form6Example2" class="form-control" name="nom"/>
